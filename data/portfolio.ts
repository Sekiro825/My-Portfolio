  ...
  projects: [
    {
      ...
      featured: true,
      matchScore: 99,
      rating: "TV-MA • AI/Cybersecurity",
      duration: "1 Season • Enterprise",
      top10Rank: 1,
      targetPersonas: ["employer", "techlead", "explorer"],
      backdrop: {
        kind: "circuit",
        from: "#0d1b2a",
        via: "#1b2a4a",
    ...
    },
    {
      ...
      featured: true,
      matchScore: 98,
      rating: "PG-13 • Full-Stack",
      duration: "Movie • Web App",
      top10Rank: 2,
      targetPersonas: ["employer", "explorer", "critic"],
      backdrop: {
        kind: "gradient",
        from: "#0b1a2e",
        via: "#1a3a5e",
    ...
    },
    {
      ...
      featured: true,
      matchScore: 97,
      rating: "PG-13 • Mobile/GenAI",
      duration: "Limited Series",
      top10Rank: 3,
      targetPersonas: ["explorer", "techlead", "critic"],
      backdrop: {
        kind: "gradient",
        from: "#1a0d2e",
        via: "#2d1b4e",
    ...
    },
    {
      ...
      featured: false,
      matchScore: 95,
      rating: "PG • Social & Maps",
      duration: "1 Season • Web Platform",
      top10Rank: 4,
      targetPersonas: ["employer", "explorer"],
      backdrop: {
        kind: "grid",
        from: "#0c0e14",
        via: "#1a1f2e",
    ...
    },
    {
      ...
      tagline: "Stealth project — Next.js & AI Security",
      ...
      tech: ["TypeScript", "Next.js", "AI Security"],
      year: 2026,
      status: "in-progress",
      repo: "https://github.com/Sekiro825/subsystem-alpha",
      featured: false,
      matchScore: 99,
      rating: "TV-MA • Stealth Project",
      duration: "Coming 2026",
      top10Rank: 5,
      targetPersonas: ["techlead", "critic"],
      backdrop: {
        kind: "grid",
        from: "#0c0e14",
        via: "#11131c",
